...
namespace Photofy.Caching
{
    ...
    public interface ICacheService
    {
        ...
        /// <param name="expiration">The expiration window</param>
        ...
        /// <param name="key">The key used to map this object</param>
        /// <param name="value">The object to insert</param>
        /// <param name="ttlMinutes">The number of minutes in which this object will expire</param>
        bool Add(string key, object value, int ttlMinutes);
        ...
        /// <summary>
        /// Clears all items in the current cache provider
        /// </summary>
        /// <returns></returns>
        void Clear();
    }
